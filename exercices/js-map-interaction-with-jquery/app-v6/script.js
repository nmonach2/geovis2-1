...
function highlightHotel(hotelId){
    ...
    var h = '<div id="hotel-details-'+hotel.id+'">' +
         '<h3>'+hotel.name+'</h3>'+
         '<p>Catégorie: '+hotel.categorie+'</p>'+
         '<p>Région: '+hotel.region+'</p>'+
         '<p>Description:<br>'+hotel.description+'</p>'+
         '<p>Prix: '+hotel.prix+' CHF</p>'+
         '<p><img style="max-width: 300px;" src="'+hotel.photo+'" /></p>'+
         '<p><button id="hotelZoom" class="btn btn-default btn-xs">Montrer sur la carte</button></p>'+
         '</div>';
    $('#details').html(h);
