...
Le dossier [app-v1](app-v1/) contient une première ébauche de l'application. Le fichier [index.html](app-v1/index.html) contient la structure, tandis que l'ensemble du code Javascript a été placé dans le fichier [script.js](app-v1/script.js).
...
Ceci nécessite évidemment de disposer d'une fonction `filtrerHotels`, ce qui n'est pas encore notre cas. Il suffit de la rajouter dans le fichier [script.js](app-v1/script.js):
